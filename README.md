...
I have tried to make the sketch as easy to follow/modify as possible with lots of comments etc. as I found it quiet confusing trying to do much with this module and difficult to find easy to understand examples/explanations so am publishing this sketch in the hope it will encourage others to have a try with these powerful and VERY affordable modules.
